...
$WIKI_TITLE = 'Study Wiki'; // name of the site
$PASSWORD = ''; // SHA1 hash
...
// default translation
$T_HOME = 'Main wiki page' ;
$T_JOVE_HOME = 'Study notes' ;
$T_SYNTAX = 'Syntax';
$T_DONE = 'Save changes';
...
h2 .par-edit,h3 .par-edit,h4 .par-edit,h5 .par-edit,h6 .par-edit {
    visibility:hidden;
    font-size:x-small
}

h2:hover .par-edit,h3:hover .par-edit,h4:hover .par-edit,h5:hover .par-edit,h6:hover .par-edit {
    visibility:visible
}
...
<tr>
    <td colspan="2">{HOME} &nbsp;&nbsp; | &nbsp;&nbsp; {RECENT_CHANGES} &nbsp;&nbsp; | &nbsp;&nbsp; {DASHBOARD}</td>
